			...
			<div id="dynamik-skin-styles-overlay" class="dynamik-skin-code-editor-overlay">
				<div class="dynamik-skin-code-editor-outer-wrap">
					...
					<div class="dynamik-skin-code-editor-wrap">
						<textarea wrap="off" id="dynamik-skin-styles" class="dynamik-tabby-textarea" name="skin_styles" rows="20"><?php if( file_exists( dynamik_get_active_skin_folder_path() . '/style.css' ) ) { echo file_get_contents( dynamik_get_active_skin_folder_path() . '/style.css' ); } ?></textarea>
					</div>
		...
		<form method="post" enctype="multipart/form-data">
			<div id="dynamik-skin-functions-overlay" class="dynamik-skin-code-editor-overlay">
				<div class="dynamik-skin-code-editor-outer-wrap">
					...
					<span class="dynamik-skin-code-editor-close">X</span>
					<div class="dynamik-skin-code-editor-wrap">
						<textarea wrap="off" id="dynamik-skin-functions" class="dynamik-tabby-textarea" name="skin_functions" rows="20"><?php if( file_exists( dynamik_get_active_skin_folder_path() . '/functions.php' ) ) { echo file_get_contents( dynamik_get_active_skin_folder_path() . '/functions.php' ); } ?></textarea>
					</div>
		...
		<form method="post" enctype="multipart/form-data">
			<div id="dynamik-skin-scripts-overlay" class="dynamik-skin-code-editor-overlay">
				<div class="dynamik-skin-code-editor-outer-wrap">
					...
					<span class="dynamik-skin-code-editor-close">X</span>
					<div class="dynamik-skin-code-editor-wrap">
						<textarea wrap="off" id="dynamik-skin-scripts" class="dynamik-tabby-textarea" name="skin_scripts" rows="20"><?php if( file_exists( dynamik_get_active_skin_folder_path() . '/scripts.js' ) ) { echo file_get_contents( dynamik_get_active_skin_folder_path() . '/scripts.js' ); } ?></textarea>
					</div>
