	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Alignment', 'dynamik' ); ?> <select id="dynamik-nav2-alignment" name="dynamik[nav2_alignment]" size="1" style="width:70px;">
					<option value="Left"<?php if( dynamik_get_design( 'nav2_alignment' ) == 'Left' ) echo ' selected="selected"'; ?>><?php _e( 'Left', 'dynamik' ); ?></option>
					<option value="Center"<?php if( dynamik_get_design( 'nav2_alignment' ) == 'Center' ) echo ' selected="selected"'; ?>><?php _e( 'Center', 'dynamik' ); ?></option>
