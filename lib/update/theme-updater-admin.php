					...
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								...
								<p class="description">
									<?php _e( 'You can manage your licenses in your ', 'dynamik' ); ?><a href="https://cobaltapps.com/my-account/" target="_blank"><?php _e( '"My Account" page', 'dynamik' ); ?></a>.
								</p>
							</td>
						</tr>
 ...
 */
function dynamik_admin_notices() {
...
add_action( 'admin_notices', 'dynamik_admin_notices' );